...
Path("amarcord-output.json").write_text(
    json.dumps(
        [
            {
                "type": "data_reduction",
                "analysis-time": datetime.datetime.utcnow().isoformat(),
                "mtz-file": str(mtz_file),
                "resolution-cc": statistics["CC half"][2],
                "resolution-isigma": statistics["dI/s(dI)"][0],
                "a": a,
                "b": b,
                "c": c,
                "alpha": alpha,
