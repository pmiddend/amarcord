...
import Amarcord.Bootstrap exposing (viewHelpButton)
...
viewHitRateAndIndexingGraphs stats =
    ...
    div []
        ...
        , div
            ...
            , p_ [ text "Here, a run was taken with 100,000 frames total. Of that, only 10,000 frames are considered a “hit”. Of those 10,000 frames, only 500 are considered “indexable”." ]
