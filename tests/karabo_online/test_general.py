...
def test_karabo_attributi_to_attributi_map_simple_int() -> None:
    ...
    assert amap[ATTRIBUTO_ID] == VALUE


def test_karabo_attributi_to_attributi_map_non_existing_attributo() -> None:
    """
    ...
    assert ATTRIBUTO_ID not in amap
...
def test_karabo_attributi_to_attributi_map_datetime() -> None:
    ...
    assert amap[ATTRIBUTO_ID] == datetime_to_attributo_string(VALUE)
