...
def _table_data_source(metadata: sa.MetaData) -> sa.Table:
    return sa.Table(
        ...
        metadata,
        sa.Column("id", sa.Integer, primary_key=True),
        sa.Column("run_id", sa.Integer, ForeignKey("Run.id"), nullable=False),
...
def _table_peak_search_parameters(metadata: sa.MetaData) -> sa.Table:
    return sa.Table(
        ...
        sa.Column("bad_pixel_map_hdf5_filename", sa.Text, nullable=True),
...
def _table_integration_parameters(metadata: sa.MetaData) -> sa.Table:
    return sa.Table(
        ...
        sa.Column("center_boxes", sa.Integer, nullable=True),
        sa.Column("overpredict", sa.Integer, nullable=True),
