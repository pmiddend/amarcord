...
def _table_beamtime(metadata: sa.MetaData) -> sa.Table:
    return sa.Table(
        "Beamtime",
        metadata,
...
def _table_experiment_type(metadata: sa.MetaData, beamtime: sa.Table) -> sa.Table:
    return sa.Table(
        "ExperimentType",
        metadata,
        sa.Column("id", sa.Integer, primary_key=True),
...
def _table_configuration(
    metadata: sa.MetaData, beamtime: sa.Table, experiment_type: sa.Table
) -> sa.Table:
    return sa.Table(
        "UserConfiguration",
        metadata,
        ...
        sa.Column(
            "beamtime_id",
            sa.Integer,
            ForeignKey(_fk_identifier(beamtime.c.id)),
            nullable=False,
        ),
...
def _table_attributo(metadata: sa.MetaData, beamtime: sa.Table) -> sa.Table:
    return sa.Table(
        "Attributo",
        metadata,
        sa.Column(
...
def _table_beamtime_schedule(metadata: sa.MetaData, beamtime: sa.Table) -> sa.Table:
    return sa.Table(
        "BeamtimeSchedule",
        metadata,
        sa.Column("id", sa.Integer(), primary_key=True),
...
def _table_chemical(metadata: sa.MetaData, beamtime: sa.Table) -> sa.Table:
    return sa.Table(
        "Chemical",
        metadata,
        sa.Column("id", sa.Integer, primary_key=True),
...
def _table_chemical_has_attributo_value(
    metadata: sa.MetaData, attributo: sa.Table, chemical: sa.Table
) -> sa.Table:
    return sa.Table(
...
def _table_run_has_attributo_value(
    metadata: sa.MetaData, attributo: sa.Table, run: sa.Table, chemical: sa.Table
) -> sa.Table:
    return sa.Table(
...
def _table_data_set_has_attributo_value(
    metadata: sa.MetaData, attributo: sa.Table, chemical: sa.Table, data_set: sa.Table
) -> sa.Table:
    return sa.Table(
...
def _table_event_log(metadata: sa.MetaData, beamtime: sa.Table) -> sa.Table:
    return sa.Table(
        "EventLog",
        metadata,
        sa.Column(
...
def _table_run(
    metadata: sa.MetaData, experiment_type: sa.Table, beamtime: sa.Table
) -> sa.Table:
    return sa.Table(
        "Run",
        metadata,
...
class DBTables:
    def __init__(
        ...
        chemical: sa.Table,
        run: sa.Table,
        run_has_attributo_value: sa.Table,
        attributo: sa.Table,
        event_log: sa.Table,
        beamtime: sa.Table,
        ...
        file: sa.Table,
        data_set: sa.Table,
        data_set_has_attributo_value: sa.Table,
        chemical_has_file: sa.Table,
        chemical_has_attributo_value: sa.Table,
        ...
        self.data_set_has_attributo_value = data_set_has_attributo_value
        ...
        self.chemical_has_attributo_value = chemical_has_attributo_value
        self.run_has_attributo_value = run_has_attributo_value
...
def create_tables_from_metadata(metadata: MetaData) -> DBTables:
    beamtime = _table_beamtime(metadata)
    chemical = _table_chemical(metadata, beamtime)
    beamtime_schedule = _table_beamtime_schedule(metadata, beamtime)
    experiment_type = _table_experiment_type(metadata, beamtime)
    run = _table_run(metadata, experiment_type, beamtime)
    file = _table_file(metadata)
    table_attributo = _table_attributo(metadata, beamtime)
    data_set = _table_data_set(metadata, experiment_type)
    event_log = _table_event_log(metadata, beamtime)
    ...
    return DBTables(
        ...
        configuration=_table_configuration(metadata, beamtime, experiment_type),
        chemical=chemical,
        run=run,
        run_has_attributo_value=_table_run_has_attributo_value(
            metadata, table_attributo, chemical, run
        ),
        attributo=table_attributo,
        event_log=event_log,
        data_set=data_set,
        data_set_has_attributo_value=_table_data_set_has_attributo_value(
            metadata, table_attributo, chemical, data_set
        ),
        ...
        chemical_has_attributo_value=_table_chemical_has_attributo_value(
            metadata, table_attributo, chemical
        ),
