...
#                     STARTED_ATTRIBUTO_ID, datetime.datetime.utcnow()
#                 )
#                 attributi.append_single(STATUS_ATTRIBUTO_ID, RUN_STATUS_RUNNING)
#                 for k, v in o.metadata.items():
#                     if k in resolved_metadata_keys:
#                         resolved_value = v.magnitude if isinstance(v, Quantity) else v
#                         attributi.append_single(
#                             sanitize_attributo_id(k), resolved_value
#                         )
#
#                 self._db.add_run(
#                     conn,
...
#             attributi_map.append_single_datetime(
