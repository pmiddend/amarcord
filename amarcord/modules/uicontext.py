...
class UIContext:
    def __init__(self, argv: List[str]) -> None:
        ...
        self.log_output.setMaximumBlockCount(1024)
        log_root_layout.addWidget(self.log_output)
        self._logging_handler = QtLoggingHandler(self.log_output)
        # Commented out for now since it probably produced a segmentation fault
