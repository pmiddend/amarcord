...
class Comments(QtWidgets.QWidget):
    def __init__(
        ...
        comment_changed: Callable[[DBComment], None],
        comment_added: Callable[[DBComment], None],
    ...
    def set_comments(self, run_id: int, comments: List[DBComment]) -> None:
    ...
    def _set_row(self, c: DBComment, now: datetime.datetime, row: int) -> None:
