...
#
#     dbcontext = DBContext(args.db_connection_url, echo=False)
...
#     while True:
#         try:
#             main_loop_iteration(args, base_directory, db)
#         except:
...
#
#
# def main_loop_iteration(args: Arguments, base_directory: Path, db: DB) -> None:
...
#             run_ids = set(db.retrieve_run_ids(conn, ProposalId(args.proposal_id)))
#             block_to_comment: Dict[str, str] = {
#                 r.directory_name: r.comment for r in db.retrieve_analysis_results(conn)
#             }
#
...
#             db.clear_analysis_results(conn, args.process_after_run_id)
